...
class OffRL_Inference:
	def __init__(self):
		...
		choice_model = int(input("Model number? 1 to 3 :"))
		
		if choice_model ==1:
			model_name = 'bco_sep14_r1_40'
		elif choice_model ==2:
			model_name = 'bco_sep14_r1_80'
		elif choice_model ==3:
			model_name = 'bco_sep14_r1_120'
